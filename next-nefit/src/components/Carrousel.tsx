  ...
  return (
    <>
      <div className="text-white">
        <Image
          className="w-full h-[42rem] object-cover brightness-50 bg-no-repeat"
          src={testeNoticiaUm}
          alt="not1"
        />
        <div className="absolute -mt-[24.5rem]  ml-[190px] w-[33rem] h-[11.75rem]">
          <div className="h-auto text-[40px] font-bold">
